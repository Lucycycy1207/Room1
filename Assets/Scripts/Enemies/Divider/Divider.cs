...
{
    [Header("Animation")]
    [SerializeField] private Animator dividerAnim;

    private float attackRange;
    private float shootingRate;

    [Header("Divider Small Prefab")]
    ...
    public override void Die()
    {
        ...
        dividerAnim.SetBool("isDead", true);
        ...
        //Spawn small enemies after large enemy is destroyed
